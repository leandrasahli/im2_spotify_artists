const genres = {
    ...
    pop: ['20244d07-534f-4eff-b4d4-930878889970','7eb1ce54-a355-41f9-8d68-e018b096d427', '6925db17-f35e-42f3-a4eb-84ee6bf5d4b0','e0140a67-e4d1-4f13-8a01-364355bee46e','afb680f2-b6eb-4cd7-a70b-a63b25c763d5', 'c8b03190-306c-4120-bb0b-6f2ebfc06ea9', '73e5e69d-3554-40d8-8516-00cb38737a1c', '650e7db6-b795-4eb5-a702-5ea2fc46c848', 'cc197bad-dc9c-440d-a5b5-d52ba2e14234', 'b8a7c51f-362c-4dcb-a259-bc6e0095f0a6', 'f4abc0b5-3f7a-4eff-8f78-ac078dbce533', 'f4fdbb4c-e4b7-47a0-b83b-d91bbfcfa387', '9fdaa16b-a6c4-4831-b87c-bc9ca8ce7eaa', '525f1f1c-03f0-4bc8-8dfd-e7521f87631b', '122d63fc-8671-43e4-9752-34e846d62a9c', 'fab34286-b8e1-4879-bce3-194e1358fbd2', '859d0860-d480-4efd-970c-c05d5f1776b8', 'f27ec8db-af05-4f36-916e-3d57f91ecf5e', 'e4bc69e2-a064-4f93-ada1-f7f209cc1cc3', 'b202beb7-99bd-47e7-8b72-195c8d72ebdd'],
    latin: ['5bdeb32d-56a5-4b6d-a768-264101fa0a0a','89aa5ecb-59ad-46f5-b3eb-2d424e941f19','de22adae-f8ac-414f-b653-b0162611bd60', 'bf24ca37-25f4-4e34-9aec-460b94364cfc','e8979f75-9110-4df8-ac70-898898d080d1','2f522f5c-111c-4ce8-8bd0-d82e97c227ad','35f866dc-c061-48ba-8157-cf2e0eac4857', 'c458e9dc-e0d5-45ea-9e83-f9d0395f030d', 'd1689304-23ac-4eae-a147-bd2e4100581a','ac367c2e-7783-41e5-a184-131da6b0c166','f0602f55-1770-483d-89bd-4bae0d0ac086', 'd262ea27-3ffe-40f7-b922-85c42d625e67', 'becd8cc6-a453-4183-af88-dedaaec859a6', '9bacf78f-9132-43da-8873-8a9eb49da0e9','d68fda90-ab8d-4799-be56-317ba4ae700f','9971d582-1582-4b48-850a-2dfe793a5d30', 'a24f2bd3-0d1b-4c03-8d91-6297ab5a2811'],
    hiphop: ['f82bcf78-5b69-4622-a5ef-73800768d9ac','5df62a88-cac9-490a-b62c-c7c88f4020f4','d5d97b2b-b83b-4976-814a-056d9076c8c3','381086ea-f511-4aba-bdf9-71c753dc5077','b95ce3ff-3d05-4e87-9e01-c97b66af13d4', '164f0d73-1234-4e2c-8743-d77bf2191051','355cc194-b8db-4af2-8678-c7ad54213f4b', 'ac9a487a-d9d2-4f27-bb23-0f4686488345', '5f6ab597-f57a-40da-be9e-adad48708203', 'f90e8b26-9e52-4669-a5c9-e28529c47894', '1d11e2a1-4531-4d61-a8c7-7b5c6a608fd2', '73fdb566-a9b1-494c-9f32-51768ec9fd27', '1036b808-f58c-4a3e-b461-a2c4492ecf1b', 'f6beac20-5dfe-4d1f-ae02-0b0a740aafd6', '8e68819d-71be-4e7d-b41d-f1df81b01d3f', '25b7b584-d952-4662-a8b9-dd8cdfbfeb64', 'b1e26560-60e5-4236-bbdb-9aa5a8d5ee19', 'a0e8a1b1-5f8f-475a-a253-17415c17d0ff', 'e0e1db18-f7ba-4dee-95ff-7ae8cf545460','2f3c4d70-0462-40da-bba3-0aec5772c556'],
...
buttons.forEach(button => {
    ...
    button.addEventListener('click', async () => {
        genreSound.currentTime = 0;
        genreSound.volume = 0.45;
        genreSound.play().catch(() => {});
        ...
        const artistPromises = ids.map(async (id) => {
            ...
            if (
                !artist_data ||
                !artist_top_song ||
                !artist_top_song.track ||
                !artist_data.artists ||
                !artist_top_song.track.length ||
                !artist_data.artists.length
            ) {
                return null;
            }
        ...
        artists.push(...results.filter(result => result !== null));

        buttons_container.style.transition = 'all 0.6s ease';
        buttons_container.style.transform = 'translate(-50%, -50%) scale(1.3)';
...
backButton.addEventListener('click', () => {
    ...
    buttons_container.style.transform = 'translate(-50%, -50%)';
